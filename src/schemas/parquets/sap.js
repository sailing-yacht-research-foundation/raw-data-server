...
const sapCombined = new parquet.ParquetSchema({
  ...
  regatta: { type: 'UTF8' },
  name: { type: 'UTF8' },
  scoring_system: { type: 'UTF8', optional: true },
  ranking_metric: { type: 'UTF8', optional: true },
  boat_class: { type: 'UTF8', optional: true },
  can_boats_of_competitors_change_per_race: { type: 'UTF8', optional: true },
  competitor_registration_type: { type: 'UTF8', optional: true },
  user_start_time_inference: { type: 'BOOLEAN', optional: true },
  control_tracking_from_start_and_finish_times: { type: 'BOOLEAN', optional: true },
  start_of_race_ms: { type: 'INT64' },
  start_of_tracking_ms: { type: 'INT64' },
  newest_tracking_event_ms: { type: 'INT64', optional: true },
  end_of_tracking_ms: { type: 'INT64' },
  end_of_race_ms: { type: 'INT64' },
  delay_to_live_ms: { type: 'INT64', optional: true },
  courses: {
    repeated: true,
    fields: {
      id: { type: 'UTF8' },
      ...
      passing_instruction: { type: 'UTF8', optional: true },
    ...
    fields: {
      ...
      boat: {
        ...
        fields: {
          ...
          boat_class_name: { type: 'UTF8', optional: true },
          ...
          boat_class_display_name: { type: 'UTF8', optional: true },
          boat_class_icon_url: { type: 'UTF8', optional: true },
        },
      },
      leg: {
        repeated: true,
        fields: {
          ...
          time_since_gun_ms: { type: 'UTF8', optional: true },
      ...
      mark_passing: {
        ...
        fields: {
          ...
          waypoint_name: { type: 'UTF8', optional: true },
